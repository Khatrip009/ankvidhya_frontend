...
export default function StrengthsPage() {
  ...
  useEffect(() => {
    fetchMediumsAndStandards();
    fetchOrdersList();
  }, []);

  const fetchMediumsAndStandards = async () => {
    try {
      ...
      console.error("Failed to fetch medium/standard lookups", err);
  ...
  const loadOrder = async (id) => {
    ...
    try {
      ...
      // Strengths (map to dropdown-friendly format)
      setStrengthRows(
